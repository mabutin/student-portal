...
<body>
    ...
    <div class="w-full flex justify-center mt-2">
        <button type="button" onclick="openTorModal()" class="rounded-sm py-2 px-4 font-medium border border-blue-500 hover:bg-blue-400 hover:text-white">Request TOR</button>
    </div>
